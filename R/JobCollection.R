...
#'  \item{array.jobs}{\code{logical(1)} signaling if jobs were submitted using \code{chunks.as.arrayjobs} or \code{as.arrayjobs}.}
#' }
...
createCollection = function(jobs, resources = list(), reg = getDefaultRegistry()) {
  ...
  jc$array.jobs   = isTRUE(resources$chunks.as.arrayjobs) || isTRUE(resources$as.arrayjobs)
